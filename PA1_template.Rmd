...
plot(weekendly$Group.1,weekendly$x,type="l",ylab="",main="weekend",col="blue",xlab="",xaxt="n")
plot(weekdaily$Group.1,weekdaily$x,type="l",ylab="",main="weekday",col="blue",xlab="")
